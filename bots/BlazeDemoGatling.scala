...
class BlazeDemoGatling extends Simulation {
  ...
  val scn = scenario("BlazeDemoGatling")
    ...
    .exec(http("2.0 - POST - /reserve.php")
      ...
      .resources(http("2.1 - GET - /assets/bootstrap.min.js")
        ...
        .exec(http("2.3 - GET - /assets/bootstrap.min.css")
          .get("/assets/bootstrap.min.css")
          .headers(headers_0))

        .exec(http("2.4 - GET - /assets/bootstrap-table.css")
          .get("/assets/bootstrap-table.css")
          .headers(headers_0))

        .exec(http("2.5 - GET - /img/glyphicons-halflings.png")
          .get("/img/glyphicons-halflings.png")
          .headers(headers_0))
